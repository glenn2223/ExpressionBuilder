...
namespace ExpressionBuilder.Test.Unit
{
    ...
    public class OperationTests
    {
        List<Operation> operations = new List<Operation> { Operation.EqualTo, Operation.Contains, Operation.StartsWith, Operation.EndsWith, Operation.NotEqualTo, Operation.GreaterThan, Operation.GreaterThanOrEqualTo, Operation.LessThan,
            Operation.LessThanOrEqualTo, Operation.Between, Operation.IsNull, Operation.IsEmpty, Operation.IsNullOrWhiteSpace, Operation.IsNotNull, Operation.IsNotEmpty, Operation.IsNotNullNorWhiteSpace, Operation.DoesNotContain };
        ...
        List<string> operationsNames = new List<string> {
            ...
            "Not equal to", "Starts with", "Does not contain", "Between", "Contains"
        };

        List<string> operationsNamesptBR = new List<string> {
            "entre", "contem", "termina com", "igual", "maior que", "maior que ou igual", "é vazio", "não é vazio", "não é nulo", "não é nulo nem vazio", "é nulo", "é nulo ou vazio", "menor que","menor que ou igual", "diferente",
